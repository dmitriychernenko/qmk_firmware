...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_104_ansi(
        KC_ESC,   KC_BRID,  KC_BRIU,  KC_MICT,  KC_LAPA,  UG_VALD,  UG_VALU,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,    KC_VOLU,  KC_SNAP,  UG_NEXT,  KC_DEL,   KC_F13,   KC_F14,   KC_F15,   KC_MUTE,
