...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [FN] = LAYOUT_ansi_60(
        ...
        UG_TOGG, UG_NEXT,  UG_VALU,  UG_HUEU, UG_SATU, _______, _______, _______, KC_HOME, KC_PGUP, KC_LEFT, KC_RIGHT,                      _______,
        _______,           UG_PREV,  UG_VALD, UG_HUED, UG_SATD, BAT_LVL, NK_TOGG, _______, KC_END,  KC_PGDN, KC_DOWN,             _______, _______,
